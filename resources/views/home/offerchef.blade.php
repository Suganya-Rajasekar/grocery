...
<?php //echo "<pre>"; print_r($alloffer);echo "</pre>";exit;?>
  <div class="container-fluid  ">
        ...
        {{-- @if(count($cuisine) > 0) --}}
          <div class="">
            <div class=" area-asw-filter">      
              ...
              <a class="font-montserrat btn btn-theme font-weight-normal" onclick="seeexplore('cuisines')">Back</a>
                ...
                {{--@for($j=0;$j<5;$j++)--}}
                  <div class="chef-lists mb-5 cuisine-detail-asw">
                          ...
                          <div class="o-hid justify-content-between d-flex justify-content-between">
                            <div class="w-asw-85 mw-0">
                              <div class="chefname">
                                <a href="{!!url('/chef/'.$v->id)!!}" >
                                  <h2 class="text-black font-weight-bold font-opensans">{{$v->name}}{{-- <span class="offer-chef">20% OFF</span> --}}</h2>
                                </a>
                                ...
                                <p class="elipsis-text d-none font-montserrat d-sm-block">
                                  <!--Description that explain about the dish or chef.-->{{ strip_tags($v->chef_description) }}
                                </p>
                                <div class="sqr-star">
                            ...
                            <div class="text-center">
                              ...
                              <div class="pricefornos">
                                <h4 class="text-theme font-montserrat text-nowrap">&#8377;@if($v->chef_restaurant) {{$v->chef_restaurant->budget_name}} @endif</h4>
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="chefsfood cuisine-detail-asw-food">
                      @if($v->chef_restaurant) 
                      <div class="owl-carousel see-more owl-theme">
                       @foreach($v->chef_restaurant->approved_dishes as $food_k => $food_val)
                        {{--@for($i=0;$i<5;$i++)--}}
                          <div class="item">
