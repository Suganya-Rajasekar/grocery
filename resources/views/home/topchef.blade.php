                            ...
                            <div class="row mt-5">
                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 mb-5">
                                    <div class="chefsfoodlists">
                                        <div class="foodimg">
                                            <img src="https://img.webmd.com/dtmcms/live/webmd/consumer_assets/site_images/articles/health_tools/food_combos_lose_weight_slideshow/493ss_thinkstock_rf_variety_raw_foods.jpg" alt="">
                                        </div>
                                        <div class="fooddesc">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 mb-5">
                                    <div class="chefsfoodlists">
                                        <div class="foodimg">
                                            <img src="https://images.all-free-download.com/images/graphiclarge/chicken_picture_3_167117.jpg" alt="">
                                        </div>
                                        <div class="fooddesc">
                                            <h2 class="food-name text-black">
                                                vadai
