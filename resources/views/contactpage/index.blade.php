...
<div class="panel panel-flat">
	...
	<!-- <div class="panel-body">	
		<div class="pull-right">
			...
			<div class="form-group mb-10">
				...
				<a href="{!! url('admin/contactpage') !!}" class="btn btn-danger font-monserret ml-2 mb-2"><i class="icon-cancel-circle2"></i> Clear</a>
				@endif
	...
	<div class="table-responsive-xl">
		...
		<tbody>
			...
			@php
            $user = App\Models\Contact::where('id', $value->id)->first();
            @endphp
			<tr>
				<td>{!! ($key+1)+$page !!}</td>
				<td>{!! $user->name !!}</td>
...
<div class="mt-10">
	<div class="pull-left font-montserrat">
		Displaying {{$contactpage->count()+$page}} of {{ $contactpage->total() }} data(s).
	</div>
	<div class="pull-right">
		{{$contactpage->appends(Request::except('page'))->render()}}
	</div>
</div>
<!-- /basic responsive configuration -->
@endsection
