	...
	<div class="panel-body">
		<div class="pull-left">
			...
			<div class="panel-heading">
				<a href="{!!url(getRoleName().'/mediapress/create')!!}"><button type="button" class="btn bg-teal-400 btn-labeled btn-rounded"><b><i class="icon-pie-chart3"></i></b> {{ ('Add New') }}</button></a>
			</div>
			@endif
				...
				<tr>
					...
					<td>				
						<div class="text-center d-flex">
							@if($access->edit)
							<a href="{!!url(getRoleName().'/mediapress/'.$value->id.'/edit'.$url)!!}"><button type="button" class="btn mr-2 btn-success btn-xs" data-name="{!! $value->name !!}" data-id="{!!$value->id!!}" data-status="{!! $value->status !!}" ><b><i class="fa fa-edit"></i></b></button></a>
							@endif
							@if($access->remove)
							<form action="{!!url(getRoleName().'/mediapress/'.$value->id.'/delete/')!!}" method="post" enctype="Multipart/form-data">
