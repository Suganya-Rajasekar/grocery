...
<div class="page-header page-header-default">
	<div class="page-header-content">
		<div class="page-title">
			<h5><span class="text-semibold">	</span> - Popular recipe</h5>
		</div>
	</div>
	...
	<div class="panel-body">
		<div class="pull-left">
			...
			<div class="panel-heading">
				<a href="{!!url(getRoleName().'/popular_recipe/create')!!}"><button type="button" class="btn bg-teal-400 btn-labeled btn-rounded"><b><i class="icon-pie-chart3"></i></b> {{ ('Add New') }}</button></a>
			</div>
			@endif
				...
				<tr>
					...
					<td>				
						<div class="text-center d-flex">
							@if($access->edit)
							<a href="{!!url(getRoleName().'/popular_recipe/'.$value->id.'/edit'.$url)!!}"><button type="button" class="btn mr-2 btn-success btn-xs" data-name="{!! $value->name !!}" data-id="{!!$value->id!!}" data-status="{!! $value->status !!}" ><b><i class="fa fa-edit"></i></b></button></a>
							@endif
							@if($access->remove)
							<form action="{!!url(getRoleName().'/popular_recipe/'.$value->id.'/delete/')!!}" method="post" enctype="Multipart/form-data">
...
<div class="mt-10">
	<div class="pull-left font-montserrat">
		Displaying {{$popular->count()+$page}} of {{ $popular->total() }} data(s).
	</div>
	<div class="pull-right">
		{{$popular->appends(Request::except('page'))->render()}}
	</div>
</div>
<!-- /basic responsive configuration -->
...
<div id="modal_cuisine" class="modal fade">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			...
			<form action="{!!url(getRoleName().'/popular_recipe/store')!!}" method="POST" enctype="Multipart/form-data">
