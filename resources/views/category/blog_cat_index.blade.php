...
<div class="page-header page-header-default">
	<div class="page-header-content">
		<div class="page-title">
			<h5><span class="text-semibold">Master</span> - Blog Categories</h5>
		</div>
	</div>
	...
	@endif
		...
		<div class="pull-right">
		    <form class="form-inline" method="GET">
				...
				<a href="{!! url('admin/common/blog_category') !!}" class="btn btn-danger font-monserret ml-2 mb-2"><i class="icon-cancel-circle2"></i> Clear</a>
				@endif
			</form>
		</div>
		<br><br>
			...
			<tr>
				...
				<td >
					<div class="text-center d-flex">
						...
						@endif
						@if($access->remove)
						<form action="{!!url(getRoleName().'/blog_category/'.$value->id.'/delete/')!!}" method="post" enctype="Multipart/form-data">
	...
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">Add/Edit Blog Category</h5>
				<button type="button" class="close" data-dismiss="modal">&times;</button>
			</div>
			<form action="{!!url('blog_category/store')!!}" method="POST" enctype="Multipart/form-data">
				<div class="modal-body">
					{{ csrf_field() }}{{ method_field('PUT') }}
					<input type="hidden" name="type" vlaue="tag_category">
