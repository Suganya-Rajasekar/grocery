                        ...
                        <div class="login-form">
                            ...
                            <form method="POST" action="{{ route('register') }}" id="reg-form">
                                ...
                                <div class="social-login">
                                    <h6 class="font-montserrat">{{ __('Or Register with Social account') }}</h6>
                                    <div class="social-links">
                                        @if(env('FACEBOOK_CLIENT_ID') != null)
                                        <a class="facebook font-montserrat" href="{{ url('login/facebook') }}"><i style="float: left;"><img src="{!! asset('assets/img/fb-icon.png') !!}"></i> {{ __('Facebook') }}</a>
                                        @endif
                                    ...
                                    <div class="social-links-asw">
                                        <div class="d-flex">
                                            <div class="fb font-montserrat"><a href="{{ url('/auth/facebook') }}" target="_blank" title="facebook" onclick="gtag_report_conversion()"><i class="fa fa-facebook"></i> Facebook</a></div>
                                            <div class="gl font-montserrat"><a href="{{ url('/auth/google') }}" target="_blank" title="google" onclick="gtag_report_conversion()"><i class="fa fa-google"></i> Google</a></div>
                                        </div>
                                    </div>
                                </div>
                            </form>
