...
<div class="page-header page-header-default">
	<div class="page-header-content">
		<div class="page-title">
			<h5><span class="text-semibold">Customer</span> - Favourites</h5>
		</div>
	</div>
...
@endphp
<!-- Basic table-responsive-xlnsive configuration -->
		...
		<form class="form-inline" method="GET">
			<div class="form-group mb-2">
					...
					<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
						...
						<a class="dropdown-item" href="{!! url(getRoleName().'/favouritesexport/'.$dn.'?user_id='.\Request::query('user_id').'&vendor_id='.\Request::query('vendor_id')) !!}">{!! $dv !!}</a>
						@endforeach
					</div>
					</div>
			...
			<div class="form-group mb-2">
				...
				<a href="{!! url('admin/customer/favourites') !!}" class="btn btn-danger font-monserret ml-2 mb-2"><i class="icon-cancel-circle2"></i> Clear</a>
				@endif
			</form>
		</div>
		...
		<table class="table table-bordered">
			...
			<tbody>
				...
				<tr>
					...
					<td>{!!isset($value->getMenuDetails) ? $value->getMenuDetails['name'] : ''!!}</td>
					@if(getRoleName()=='admin' && $access->remove)
					<td>
						<form action="{!!url(getRoleName().'/favourites/'.$value->id.'/delete/')!!}" method="post" enctype="Multipart/form-data">
