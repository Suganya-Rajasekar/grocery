...
<div class="page-header page-header-default">
	<div class="page-header-content">
		<div class="page-title">
			<h5><span class="text-semibold">Reports</span> - Tickets wise report</h5>
		</div>
	</div>
	...
	<div class="panel-body">
		...
		<div class="pull-left">
			<form class="form-inline" method="GET">
				<div class="form-group mb-2 ml-4">
					<div class="dropdown">	
						...
						<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
							...
							<a class="dropdown-item" href="{!! url(getRoleName().'/ticketexport/'.$dn.'?filter='.\Request::query('filter').'&chef='.\Request::query('chef')) !!}">{!! $dv !!}</a>
							@endforeach
						</div>
					</div>
				</div>
				...
				@endif
				<div class="form-group mb-2">
					<input type="text" class="form-control" name="filter" placeholder="Search ticketname " value="{!! \Request::query('filter') !!}">
				</div>
				<div class="form-group mb-2">
		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					@if(\Request::segment(1) == 'admin')
					<th class="ws-nowrap">Event Name</th>
					<th class="ws-nowrap">Event date & time</th>
					@endif
					<th class="ws-nowrap">Ticket Name</th>
			...
			<tbody>
				...
				<tr>
					...
					<td>{{ date('d-m-Y',strtotime($value->restaurant->event_time[0]))." ".$value->restaurant->event_time[1] }}</td>
					@endif
					<td>{!!$value->name!!}</td>
